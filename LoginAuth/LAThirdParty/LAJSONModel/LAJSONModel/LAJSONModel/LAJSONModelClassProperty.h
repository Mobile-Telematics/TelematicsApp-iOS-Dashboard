...
/**
 * **You do not need to instantiate this class yourself.** This class is used internally by LAJSONModel
 ...
 */
@interface LAJSONModelClassProperty : NSObject
...
@property (assign, nonatomic) BOOL isStandardLAJSONType;
