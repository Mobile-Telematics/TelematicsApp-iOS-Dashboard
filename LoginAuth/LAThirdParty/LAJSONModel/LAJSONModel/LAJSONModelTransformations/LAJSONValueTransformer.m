...
@implementation LAJSONValueTransformer
...
-(id)LAJSONObjectFromNSSet:(NSSet*)set
{
    return [set allObjects];
}

-(id)LAJSONObjectFromNSMutableSet:(NSMutableSet*)set
{
    return [set allObjects];
}
...
-(NSString*)__LAJSONObjectFromNSDate:(NSDate*)date
{
...
- (id)LAJSONObjectFromNSTimeZone:(NSTimeZone *)timeZone {
