...
#pragma mark - LAJSONValueTransformer interface
/**
 ...
 */
@interface LAJSONValueTransformer : NSObject
 ...
 */
- (NSArray *)LAJSONObjectFromNSSet:(NSSet *)set;
 ...
 * @return an array with the set's elements
 */
- (NSArray *)LAJSONObjectFromNSMutableSet:(NSMutableSet *)set;
 ...
 */
- (NSNumber *)LAJSONObjectFromBOOL:(NSNumber *)number;
 ...
 * @return the resulting string
 */
- (NSString *)LAJSONObjectFromNSURL:(NSURL *)url;
 ...
 * @return the resulting string
 */
- (NSString *)LAJSONObjectFromNSTimeZone:(NSTimeZone *)timeZone;
