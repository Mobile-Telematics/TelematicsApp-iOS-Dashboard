...
#define DefaultTitle @"Great Job!"
#define DefaultFixTitle @"LET'S GO!"
...
- (void)initialize {
    ...
    if (!self.message) {
        self.message = @"You have given access to all permissions and now you can use full power of\nZenRoad app!";
    }
...
- (void)setupAd1Lbl {
    ...
    self.customView.ad1Text.text = @"Improve your Driving Safety and Performance";
    if (IS_IPHONE_5 || IS_IPHONE_4) {
    ...
    if (IS_IPHONE_XS_MAX || IS_IPHONE_13_PROMAX || IS_IPHONE_8P) {
    ...
    NSMutableAttributedString *textAfterIcon = [[NSMutableAttributedString alloc] initWithString:@"      Improve your Driving Safety and Performance"];
...
//    }
    ...
    if (IS_IPHONE_5 || IS_IPHONE_4) {
        self.customView.ad1Text.font = [Font medium11];
    }
...
- (void)setupAd2Lbl {
    ...
    self.customView.ad2Text.text = @"Compete with Others";
    if (IS_IPHONE_5 || IS_IPHONE_4) {
    ...
    NSMutableAttributedString *textAfterIcon = [[NSMutableAttributedString alloc] initWithString:@"      Compete with Others"];
    [completeText appendAttributedString:textAfterIcon];
    
    if (IS_IPHONE_5 || IS_IPHONE_4) {
        self.customView.ad2Text.font = [Font medium11];
    }
...
- (void)setupAd3Lbl {
    ...
    self.customView.ad3Text.text = @"Get Rewarded";
    if (IS_IPHONE_5 || IS_IPHONE_4) {
    ...
    NSMutableAttributedString *textAfterIcon = [[NSMutableAttributedString alloc] initWithString:@"      Get Rewarded"];
...
//    }
    ...
    if (IS_IPHONE_5 || IS_IPHONE_4) {
        self.customView.ad3Text.font = [Font medium11];
    }
...
- (void)setupButtons {
    ...
    [self.customView.okBtn setTitle:@"LET'S GO!" forState:UIControlStateNormal];
