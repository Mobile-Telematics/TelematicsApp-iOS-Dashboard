...
//
//@implementation ProgressBarSpeed
//
...
//
//+ (void)initialize {
//    if (self == [ProgressBarSpeed class]) {
//        ProgressBarSpeed *appearance = [ProgressBarSpeed appearance];
...
//        [appearance setBarFillColor:[Color officialGreenColor]];
