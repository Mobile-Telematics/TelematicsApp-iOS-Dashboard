...
#define DefaultTitle @"Permission status"
#define DefaultMessage @"To record your trips and get your score, we need permission for the application, below shows their current status"
#define DefaultGPSTitle @"Set location always"
#define DefaultMotionTitle @"Enable Motions"
#define DefaultPushTitle @"Enable Push-notifications"
...
#pragma mark - General Popup Build
...
- (void)setupButtons {
    ...
    [self.customView.closeButton addTarget:self action:@selector(closeButtonAction) forControlEvents:UIControlEventTouchUpInside];
    self.customView.closeButton.hidden = YES;
}
...
- (void)setupButtonGPS {
    ...
    if (IS_IPHONE_5 || IS_IPHONE_4) {
        ...
        self.customView.gpsButton.imageEdgeInsets = UIEdgeInsetsMake(0, 46, 0, 0);
    } else if (IS_IPHONE_13_PROMAX) {
        self.customView.gpsButton.titleEdgeInsets = UIEdgeInsetsMake(0, 20, 0, 0);
        self.customView.gpsButton.imageEdgeInsets = UIEdgeInsetsMake(0, 137, 0, 0);
    } else if (IS_IPHONE_13_PRO) {
        self.customView.gpsButton.titleEdgeInsets = UIEdgeInsetsMake(0, 20, 0, 0);
        self.customView.gpsButton.imageEdgeInsets = UIEdgeInsetsMake(0, 102, 0, 0);
    } else if (IS_IPHONE_XS_MAX || IS_IPHONE_8P) {
        self.customView.gpsButton.titleEdgeInsets = UIEdgeInsetsMake(0, 20, 0, 0);
        self.customView.gpsButton.imageEdgeInsets = UIEdgeInsetsMake(0, 117, 0, 0);
    } else {
        self.customView.gpsButton.titleEdgeInsets = UIEdgeInsetsMake(0, 20, 0, 0);
        self.customView.gpsButton.imageEdgeInsets = UIEdgeInsetsMake(0, 79, 0, 0);
    }
...
- (void)setupButtonMotion {
    ...
    if (IS_IPHONE_5 || IS_IPHONE_4) {
        ...
        self.customView.motionButton.imageEdgeInsets = UIEdgeInsetsMake(0, 163, 0, 0);
    } else if (IS_IPHONE_13_PRO) {
        self.customView.motionButton.titleEdgeInsets = UIEdgeInsetsMake(0, 20, 0, 0);
...
- (void)setupButtonPush {
    ...
    if (IS_IPHONE_5 || IS_IPHONE_4) {
        ...
        self.customView.pushButton.imageEdgeInsets = UIEdgeInsetsMake(0, 93, 0, 0);
    } else if (IS_IPHONE_13_PRO) {
        self.customView.pushButton.titleEdgeInsets = UIEdgeInsetsMake(0, 20, 0, 0);
...
- (void)closeButtonAction {
    [_delegate closeButtonAction:self.customView button:self.customView.closeButton];
}
