...
@interface IndicatorsResultResponse: LAResponseObject
...
@property (nonatomic, strong) NSNumber<Optional>* AccelerationsCount;
@property (nonatomic, strong) NSNumber<Optional>* BrakingsCount;
@property (nonatomic, strong) NSNumber<Optional>* CorneringsCount;
