...
//    CGContextSetLineWidth(context, self.ringThickness);
//    CGContextBeginPath(context);
//    CGContextAddArc(context, center.x, center.y, ringRadius, M_PI_4 + 1.252 * M_PI, M_PI_4 + 1.380 * M_PI, 0);
//    CGContextSetStrokeColorWithColor(context, [Color curveRedColorAlpha].CGColor);
//    CGContextStrokePath(context);
//
//    CGContextSetLineWidth(context, self.ringThickness);
//    CGContextBeginPath(context);
//    CGContextAddArc(context, center.x, center.y, ringRadius, M_PI_4 + 1.380 * M_PI, M_PI_4 + 1.382 * M_PI, 0);
//    CGContextSetStrokeColorWithColor(context, [Color officialWhiteColor].CGColor);
//    CGContextStrokePath(context);
