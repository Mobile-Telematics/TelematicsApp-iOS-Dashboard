...
//
//  Created by pp@datamotion.ai on 24.08.21.
...
- (instancetype)init{
    ...
    if (self) {
        ...
        for (UIView * vim in [UIApplication sharedApplication].keyWindow.subviews) {
            if ([vim isKindOfClass:[ZRRegPopup class]]) {
                break;
                return self;
            }
        }
        ...
        [confirmBttn setTitle:@"CONFIRM" forState:UIControlStateNormal];
