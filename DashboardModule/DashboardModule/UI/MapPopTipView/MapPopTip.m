...
- (void)commonInit {
    ...
    _rounded = NO;
    _offsetAnchorHeight = kDefaultOffset;
...
- (void)setup {
    ...
    float offset = self.offsetAnchorHeight * ((self.direction == MapPopTipDirectionUp || self.direction == MapPopTipDirectionLeft || self.direction == MapPopTipDirectionNone) ? -1 : 1);
