...
typedef NS_ENUM(NSInteger, ZenActionSheetStyle) {
    ZenActionSheetStyleLight,
    ZenActionSheetStyleDark
};
...
@interface ZenActionSheet : UIView


@property (nonatomic, strong) NSString *title;
@property (nonatomic, strong) UIView *headerView;
@property (nonatomic, assign) ZenActionSheetStyle style UI_APPEARANCE_SELECTOR;
