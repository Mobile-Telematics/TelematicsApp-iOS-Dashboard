...
#import "ZRTextField.h"

@interface ZRTextField () <UITextFieldDelegate>
...
- (void)setLeftIconNormal:(UIImage *)leftIconNormal {
    ...
    if (@available(iOS 13.0, *)) { 
        ...
        //self.leftBtnView.autoresizingMask = UIViewAutoresizingFlexibleWidth|UIViewAutoresizingFlexibleHeight;
