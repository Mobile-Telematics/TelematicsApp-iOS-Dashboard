...
#import "EventReviewPopupDelegate.h"
...
@interface EventReviewPopupDelegate()

@property (strong, nonatomic) EventReviewPopup      *customView;
...
@implementation EventReviewPopupDelegate
...
#pragma mark - Event Popup Build

- (void)setEventReviewPopup {
    [self initialize];
    
    self.customView = [[[NSBundle mainBundle] loadNibNamed:@"EventReviewPopup" owner:nil options:nil] firstObject];
...
- (void)setBlurredBackground {
    if (!UIAccessibilityIsReduceTransparencyEnabled() && self.blurBackground) {
        ...
        if (self.dismissOnBackgroundTap) {
            UITapGestureRecognizer *tapGesture = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(hideEventReviewPopup)];
...
//        [self.customView.noEventBtn setBackgroundImage:[UIImage imageNamed:@"events_braking_short"] forState:UIControlStateNormal];
...
//        [self.customView.noEventBtn setBackgroundImage:[UIImage imageNamed:@"events_acceleration_short"] forState:UIControlStateNormal];
//        [self.customView.noEventBtn addTarget:self action:@selector(noEventClaimButtonAction) forControlEvents:UIControlEventTouchUpInside];
//    } else if ([self.claim_selectedEventTypeMarker isEqualToString:@"Cornering"]) {
//        self.customView.noEventTextLbl.text = @"Cornering";
//        [self.customView.noEventBtn setBackgroundImage:[UIImage imageNamed:@"events_cornering_short"] forState:UIControlStateNormal];
//        [self.customView.noEventBtn addTarget:self action:@selector(noEventClaimButtonAction) forControlEvents:UIControlEventTouchUpInside];
//    } else if ([self.claim_selectedEventTypeMarker isEqualToString:@"Phone Usage"]) {
//        self.customView.noEventTextLbl.text = @"Phone Usage";
//        [self.customView.noEventBtn setBackgroundImage:[UIImage imageNamed:@"clpop_red_phone"] forState:UIControlStateNormal]; //NEED UPDATE
//        [self.customView.noEventBtn addTarget:self action:@selector(noEventClaimButtonAction) forControlEvents:UIControlEventTouchUpInside];
//    }
